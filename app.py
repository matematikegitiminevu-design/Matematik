...
HEDEF_ZAMAN_GENEL = "2026-06-24 20:00:00"
        ...
        st.markdown(
            ...
            <div style="background-color: #111a2e; border: 1px solid #1e293b; border-radius: 8px; padding: 15px 20px; margin: 15px 0 20px 0; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                <p style="margin: 0; font-size: 0.95rem; color: #cbd5e1; line-height: 1.5;">
                    ℹ️ <b>Platform Hakkında:</b> İlköğretim matematik eğitimini modern dijital araçlarla harmanlayan ve yapay zekâ teknolojilerini sınıfa taşıyan yeni nesil bir öğrenme alanı.
                </p>
