...
# --- 3. AŞAMA: DERS NOTLARI VE PDF ARŞİVİ ---
    ...
    # Sidebar (Yan Menü)
    with st.sidebar:
            st.title(f"♾️ Hoş Geldin, {st.session_state['aktif_user'].capitalize()}! Bir sorun olduğunda bizimle iletişime geçebilirsin")
            ...
            <a href="https://wa.me/90**********?text=Merhaba,%20CYHN%20Matematik%20Portalı%20üzerinden%20ulaşıyorum." target="_blank" class="sidebar-custom-button wp-button">
                📞 WhatsApp İletişim
            </a>
